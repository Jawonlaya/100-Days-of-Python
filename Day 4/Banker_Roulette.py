...
# Geenrate random numbers between 0 and last index
random_pref = random.randint(0, val -1)

# Pick out who will be paying the bill
person_paying = names[random_pref]

# Print out the person that will pay the bill 
